...
struct CmdEvent : public QEvent
{
  ...
  CmdEvent(const CmdEnum& cmd_value) : QEvent(QEvent::Type(PACKML_CMD_EVENT_TYPE)), cmd(cmd_value)
  {
  }
...
{
  StateCompleteEvent() : QEvent(QEvent::Type(PACKML_STATE_COMPLETE_EVENT_TYPE))
  {
  }
};
...
struct ErrorEvent : public QEvent
{
  ErrorEvent(const int& code_value)
    : QEvent(QEvent::Type(PACKML_ERROR_EVENT_TYPE)), code(code_value), name(), description()
  {
  }

  ErrorEvent(const int& code_value, const QString& name_value, const QString& description_value)
    : QEvent(QEvent::Type(PACKML_ERROR_EVENT_TYPE)), code(code_value), name(name_value), description(description_value)
  {
  }
